    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            pick1 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(90,10),new Pose(140.6144578313253, 47.0120481927711),new Pose(134.8433734939759,7.855421686746997)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(75), Math.toRadians(-100))
                    .build();
