        ...
        switch (state) {
            case PRELOAD:
                ...
                if (!currentAction && timer.milliseconds() > 8000) {
                    state = AutoFast.ShootStates.CYCLE_3;
                    timer.reset();
                    timer.startTime();
            ...
            case CYCLE_3:
                ...
                if (!currentAction) {
                    state = AutoFast.ShootStates.SHOOT_3;
                    timer.reset();
                    timer.startTime();
                }
                break;
            case SHOOT_3:
                ...
                if (!currentAction&&timer.milliseconds()>6000) {
                    state = AutoFast.ShootStates.CYCLE_2;
                    timer.reset();
                    timer.startTime();
                    robot.outtake.setLinkage(0.92);
                    robot.intake.setPower(0);
            ...
            case CYCLE_2:
                ...
                if (!currentAction) {
                    state = AutoFast.ShootStates.SHOOT_2;
                    timer.reset();
                    timer.startTime();
...
//                }
                ...
                if (!currentAction&&timer.milliseconds()>6000) {
                    state = AutoFast.ShootStates.CYCLE_1;
                    timer.reset();
                    timer.startTime();
                    robot.outtake.setLinkage(0.92);
                    robot.intake.setPower(0);
            ...
            case CYCLE_1:
                ...
                if (!currentAction) {
                    state = AutoFast.ShootStates.SHOOT_1;
            ...
            case SHOOT_1:
                ...
                if (!currentAction&&timer.milliseconds()>5000) {
                    state = AutoFast.ShootStates.LEAVE;
                    timer.reset();
                    timer.startTime();
                }
                break;
            case LEAVE:
                ...
                if (!currentAction) {
                    state = AutoFast.ShootStates.END;
                }
                break;
            case END:
                break;
