...
@Autonomous
public class ActualBlue extends LinearOpMode {
    ...
    final Pose2d SPIKE3 = new Pose2d(-22, -52, Math.toRadians(270));
    final Pose2d SPIKE1Init = new Pose2d(33, -10, Math.toRadians(270));
    final Pose2d SPIKE2 = new Pose2d(10, -57, Math.toRadians(270));
    final Pose2d SPIKE1 = new Pose2d(33, -51, Math.toRadians(270));
