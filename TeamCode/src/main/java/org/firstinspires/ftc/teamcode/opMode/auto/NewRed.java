...
@Autonomous(name = "Pedro Pathing Auto aarav--NewRed", group = "Autonomous")
public class NewRed extends OpMode {
    ...
    private final Pose Spike1End = new Pose(129.06024096385542, 83.03614457831327, 0);

    private final Pose Bez2End = new Pose(84.81927710843374, 58.60240963855421, 0);
    private final Pose Bez2Control = new Pose(96.26506024096385, 54.795180722891565, 0);
    private final Pose Spike2End = new Pose(130, 60, 0);

    private final Pose Bez3Control = new Pose(85.59036144578313, 25.060240963855428, 0);
    ...
    public void buildPaths() {
        ...
        PrepSpike1 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(scorePose.getHeading(), Bez1End.getHeading(),0.5)
                .build();
        ...
        BackGate = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(35),scorePose.getHeading())
                .build();

        PrepSpike2 = follower.pathBuilder()
                .addPath(new BezierCurve(scorePose, Bez2Control, Bez2End,Spike2End))
                .setLinearHeadingInterpolation(scorePose.getHeading(), Bez2End.getHeading(),0.5)
                .build();
        ...
        PrepSpike3 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(scorePose.getHeading(), Spike3End.getHeading(),0.5)
                .build();
