...
public class BlueClose extends OpMode {
    ...
    private final Pose scorePose = new Pose(144-84, 84, Math.toRadians(180-0));
...
//        blocker.setPosition(TeamConstants.BLOCKER_CLOSE);
    ...
    private void shoot(PathChain nextPath, boolean skip) {
        ...
        if (!follower.isBusy()) {
            if(!skip){
                turret.turretServo.setPosition(0.68);
                turret.turretServo2.setPosition(0.68);
    ...
    private void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 10:
                ...
                turret.turretServo.setPosition(0.85);
                turret.turretServo2.setPosition(0.85);
                break;
            case 11:
                resetTimers();
