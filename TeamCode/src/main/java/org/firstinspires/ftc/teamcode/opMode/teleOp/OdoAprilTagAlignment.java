...
import org.firstinspires.ftc.teamcode.subsystem.OdoApril;

@TeleOp(name = "OdoAprilTagAlignment", group = " ")
public class OdoAprilTagAlignment extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        OdoApril odoAprilTagAlignment = new OdoApril(hardwareMap, telemetry, drive);
