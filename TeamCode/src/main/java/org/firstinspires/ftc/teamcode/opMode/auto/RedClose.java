...
//    Pose2d START_POSE = new Pose2d(-49.2, 50.1, Math.toRadians(-225));
//    Pose2d LSHOOT = new Pose2d(-5, 3, Math.toRadians(-225));
//    Pose2d SPIKE3 = new Pose2d(-8, 53, Math.toRadians(-260));
//    Pose2d Spike1Init = new Pose2d(40, 30,Math.toRadians(-260));
//    Pose2d SPIKE2 = new Pose2d(17, 57, Math.toRadians(-260));
   Pose2d Spike2SplineSpot = new Pose2d(14, 40, Math.toRadians(-260));
//    Pose2d SPIKE1 = new Pose2d(45, 58, Math.toRadians(-260));
    ...
    final Pose2d START_POSE = new Pose2d(-49.2, 50.1, Math.toRadians(-227));
    final Pose2d LSHOOT = new Pose2d(-5, 3, Math.toRadians(-227));
    final Pose2d SPIKE3 = new Pose2d(-8, 57, Math.toRadians(-270));
    final Pose2d Spike1Init = new Pose2d(40, 10,Math.toRadians(-270));
    Pose2d SPIKE2 = new Pose2d(17, 56, Math.toRadians(-275));
    final Pose2d SPIKE1 = new Pose2d(40, 68, Math.toRadians(-270));
    ...
    ShootStates state = RedClose.ShootStates.PRELOAD;
    DcMotorEx transfer;
    ...
    public void build_paths() {
        ...
        TrajectoryActionBuilder toSpike2Path = robot.drive.drive.actionBuilder(LSHOOT) // GOOD
                ...
                .splineToLinearHeading(
                        new Pose2d(14, 10,Math.toRadians(-270)),
                        Math.toRadians(-270)
                )
