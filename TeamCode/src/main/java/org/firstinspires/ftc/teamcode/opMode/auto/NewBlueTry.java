...
@Autonomous
public class NewBlueTry extends LinearOpMode {
    private final ElapsedTime timer = new ElapsedTime();

    Pose2d START_POSE = new Pose2d(-49.2, -50.1, Math.toRadians(144));
    Pose2d LSHOOT = new Pose2d(-7, -3, Math.toRadians(225));
    Pose2d SPIKE3 = new Pose2d(-9, -50, Math.toRadians(270));
    Pose2d Spike1Init = new Pose2d(35, -10,Math.toRadians(270));
    Pose2d SPIKE2 = new Pose2d(10, -56, Math.toRadians(275));
    Pose2d Spike2SplineSpot = new Pose2d(10, -40, Math.toRadians(275));
                ...
                if(currentAction){
                    ...
                    if(timer.milliseconds()<0){
                        ...
                        if(robot.outtake.currentRPM()>2350 || wasPassedThresh){
                            ...
                            if(timer.milliseconds()>2500){ // change back to 6500
                                state = ShootStates.CYCLE_2;
                                transfer.setPower(-0.8);
                            }
