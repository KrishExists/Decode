...
public class NewBlueTry extends LinearOpMode {
    ...
    final Pose2d SPIKE1 = new Pose2d(40, 56, Math.toRadians(-270));
...
//                }
            ...
            case CYCLE_3:
                ...
                if (!currentAction) {
                    state = NewBlueTry.ShootStates.SHOOT_3;
                    timer.reset();
                    timer.startTime();
                    count = 0;
                    wasPassedThresh = false;
            ...
            case CYCLE_2:
                ...
                if (!currentAction) {
                    state = NewBlueTry.ShootStates.SHOOT_2;
                    timer.reset();
                    timer.startTime();
                    count = 0;
                    wasPassedThresh = false;
            ...
            case LEAVE:
                ...
                if (!currentAction) {
                    state = NewBlueTry.ShootStates.END;
                }
                break;
            case END:
                break;
